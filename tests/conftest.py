...
Tools and the storage manager read their harness files from the arancio working
...
storage_manager.SYSTEM_PROMPT_HARNESS_PATH = _REPO_HARNESS / "SYSTEM_PROMPT.md"

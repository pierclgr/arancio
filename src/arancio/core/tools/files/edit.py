...
class EditFileTool(BaseTool):
    ...
    :class:`~arancio.core.tools.session.ToolSession` registry that other tools populate.
    The match is strictly byte-exact and must be unique unless ``replace_all`` is set.
    """
